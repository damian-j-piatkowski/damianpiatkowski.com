...
an associated Google Drive file ID, and a creation timestamp sourced directly from the database.
...
class BlogPost:
    ...
    def __init__(self, title: str, html_content: str, slug: str, drive_file_id: str, created_at: datetime) -> None:
        """Initializes a new BlogPost instance with title, HTML content, slug, drive file ID, and creation timestamp.

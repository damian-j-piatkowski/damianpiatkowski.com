...
along with a text content field. The `created_at` column is automatically populated with the
current timestamp upon record insertion.
...
from sqlalchemy import Table, MetaData, Column, Integer, String, Text, DateTime, func
